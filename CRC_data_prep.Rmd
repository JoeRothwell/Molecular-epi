---
title: "Metabolic signatures of WCRF score"
output:
...
The following code reads in case-control and cancer control datasets and calculates metabolic signatures of WCRF score from Biocrates and fatty acid datasets.
...
library(kableExtra)
table3a %>% kable(caption = "Biocrates compounds most contributing to metabolic signatures of WCRF score and importance in the PLS model.") %>%
  kable_styling(full_width = T, position = "left") %>%
  group_rows("Predictive of higher WCRF score", 1, 7) %>%
  group_rows("Predictive of lower WCRF score", 8, 14)

table3b %>% kable(caption = "Fatty acids most contributing to metabolic signatures of WCRF score and importance in the PLS model.") %>%
  kable_styling(full_width = T, position = "left") %>%
  group_rows("Predictive of higher WCRF score", 1, 5) %>%
  group_rows("Predictive of lower WCRF score", 6, 10)
```
